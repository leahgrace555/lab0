...
function displayPics(){
  ...
  // changing from var to let in this case causes the error beceause lets are scoped to code blocks, so rando is defined in the while loop of the function but not globally where the console log was called.
  console.log(viewed);
